...
public class Ventas extends HttpServlet implements Servlet {
	...
	protected void doSomething(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		out.println("<th>Número de recibo</th>");
		...
		for(int i=0;i<vProductoEntS.size();i++) {
			...
			out.println("<td>");out.println( vProductoEntS.get(i).getIdProducto() );out.println("</td>");//Queremos imprimir la id del producto general, aunque tenemos ambas (idprod tambien está en el objeto)
