...
@WebServlet("/trabajadoresserv.view")
public class Trabajadoresserv extends HttpServlet implements Servlet {
	...
	{
		List<Trabajadores> trabajadorS=null;
		try {
			ConsultasBD consultas = new ConsultasBD();
			trabajadorS = consultas.obtenerTrabajadores();
		...
		out.println("<h1 class=\"font-weight-bold mb-0\">Bienvenido a Trabajadores</h1>");
		out.println("<p class=\"lead text-muted\">Control de Trabajadores</p>");
		out.println("</div>");
		...
		out.println("<td colspan=\"17\">Orgullosos trabajadores de la tienda Croquetitlán</th>");
		out.println("</tr>");
		//FIN TAITEL
		out.println("<tr class=\"tr-consultas-main\">");
		out.println("<th>No. Trabajador</th>");
		...
		out.println("<th>Sueldo por hora</th>");
		out.println("</tr>");
		//Renglones
		for(int i=0;i<trabajadorS.size();i++) {
			...
			out.println("<td>");out.println( trabajadorS.get(i).getIdTrabajador() );out.println("</td>");
			out.println("<td>");out.println( trabajadorS.get(i).getCatJerarquia().getJerarquia() );out.println("</td>");
			out.println("<td>");out.println( trabajadorS.get(i).getNombre() );out.println("</td>");
			out.println("<td>");out.println( trabajadorS.get(i).getApPat() );out.println("</td>");
			out.println("<td>");out.println( trabajadorS.get(i).getApMat() );out.println("</td>");
			out.println("<td>");out.println( trabajadorS.get(i).getFechaNac() );out.println("</td>");
			out.println("<td>");out.println( trabajadorS.get(i).getEmail() );out.println("</td>");
			out.println("<td>");out.println( trabajadorS.get(i).getEstado() );out.println("</td>");
			out.println("<td>");out.println( trabajadorS.get(i).getMunicipio() );out.println("</td>");
			out.println("<td>");out.println( trabajadorS.get(i).getCp() );out.println("</td>");
			out.println("<td>");out.println( trabajadorS.get(i).getCalle() );out.println("</td>");
			out.println("<td>");out.println( trabajadorS.get(i).getNumero() );out.println("</td>");
			out.println("<td>");out.println( trabajadorS.get(i).getNumInterior() );out.println("</td>");
			//Parte de trabajadores
			out.println("<td>");out.println( trabajadorS.get(i).getRfc() );out.println("</td>");
			out.println("<td>");out.println( trabajadorS.get(i).getCurp() );out.println("</td>");
			out.println("<td>");out.println( trabajadorS.get(i).getHoras() );out.println("</td>");
			out.println("<td>");out.println( "$" + trabajadorS.get(i).getSueldoHora() );out.println("</td>");
			//Cerramos renglón
			out.println("</tr>");
		} 
		out.println("</table>");            
		...
		out.println("<br><br>");
		out.println("<center>");
		out.println("<a class=\"boton-personalizado\" href=\"\">Agregar Trabajador</a>");
		out.println("<a class=\"boton-personalizado\" href=\"\">Eliminar Trabajador</a>");
