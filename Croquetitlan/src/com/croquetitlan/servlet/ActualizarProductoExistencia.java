...
@WebServlet("/actualizarproductoexistencia.view")
public class ActualizarProductoExistencia extends HttpServlet implements Servlet {
	...
	protected void doSomething(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		out.println("</div>");
		out.println("</section>");
		/*Sección de seleccionar opción*/
		//Inicio FORM
		out.println("<div class=\"container\">");
		out.println("<div class=\"content-center\">");
		out.println("<form action=\"updproductoexistecias.controller\" method=\"POST\">");
		//	Desplegable opciones
		out.println("<div class=\"form-group\">");
		out.println("<label for=\"opcion\">Nombre del producto</label>");
		out.println("<select class=\"form-control\" name=\"opcion\">");
			out.println("<option value=1>Actualizar existencias de un producto unitario</option>");
			out.println("<option value=2>Actualizar existencias de un producto de gramaje</option>");
			out.println("<option value=3>Abrir una bolsa de alimento</option>");
		out.println("</select>");
		out.println("</div>");
		//	FIN desplegable opciones
		out.println("</div>");
		out.println("</div>");
		out.println("<br>");
		out.println("<br>");
		out.println("<center>");
		out.println("<input type=\"submit\" class=\"boton-personalizado\" value=\"Aceptar\">");
		out.println("<br><br><br><br>");
		out.println("</form>");
		/*Fin de la sección de seleccionar opción*/
		out.println("<br>");
		out.println("<br>");
