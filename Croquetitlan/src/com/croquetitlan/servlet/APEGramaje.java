...
@WebServlet("/apeproductogra.view")
public class APEGramaje extends HttpServlet implements Servlet {
	...
	{
		//Desplegables
		List<CatGramaje> catGramajeS = null;
		try {
			ConsultasBD consultas = new ConsultasBD();
			catGramajeS = consultas.obtenerCatGramaje();
		...
		try {
			...
			out.println("<form action=\"upegramaje.controller\" method=\"POST\">");
			//Inician
			...
			out.println("<div class=\"form-group\">");
			out.println("<label for=\"exampleFormControlInput6\">Nueva descripción</label>");
			out.println("<input type=\"text\" class=\"form-control\" name=\"descripcion\" id=\"exampleFormControlInput6\"  placeholder=\"Ingresa la nueva descripción\">");
			out.println("</div>");
			out.println("<div class=\"form-group\">");
			...
			out.println("</div>");
			out.println("<div class=\"form-group\">");
			out.println("<label for=\"exampleFormControlInput3\">Cantidad en Kg disponibles</label>");
			...
			out.println("</div>");
			out.println("<div class=\"form-group\">");
			out.println("<label for=\"exampleFormControlInput4\">Precio por Kg</label>");
			out.println("<input type=\"number\" class=\"form-control\" step=\"0.01\" min=0.01 name=\"preciokg\" id=\"exampleFormControlInput4\" placeholder=\"$\">");
			out.println("</div>");
			out.println("<div class=\"form-group\">");
			out.println("<label for=\"exampleFormControlInput5\">Gramaje mínimo de venta(Solo en alimentos)</label>");
			out.println("<input type=\"number\" class=\"form-control\" step=\"0.001\" min=0.001 name=\"gramajemin\" id=\"exampleFormControlInput5\" placeholder=\"Kg\">");
			out.println("</div>");
			out.println("</div>");
			out.println("<br>");
			out.println("<br>");
